...
for epoch in range(opt.n_epochs):
    ...
    print('Test Avg. Loss: %f, Accuracy: %f, train time end: %f, val time end: %f' % (avg_loss.data.item(), float(total_correct) / len(data_test), training_time, validation_time))
    ...
    if accr > accr_best:
        ...
        torch.save(state_dict_generator, os.path.join(opt.output_dir, "generator.pth"))
